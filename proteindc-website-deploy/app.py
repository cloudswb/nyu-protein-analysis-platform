...
from deploy.protein_vpc_deploy_stack import NyuProteinVpcDeployStack

from deploy.protein_rds_deploy_stack import NyuProteinRDSDeployStack
from deploy.protein_neptune_deploy_stack import NyuProteinNeptuneDeployStack
from deploy.protein_neptune_serverless_deploy_stack import NyuProteinNeptuneServerlessDeployStack
from deploy.protein_neptune_notebook_deploy_stack import NyuProteinNeptuneNotebookDeployStack


from deploy.protein_cloudfront_s3_deploy_stack import NyuProteinCloudFrontS3DeployStack
from deploy.protein_layer_lambda_deploy_stack import NyuProteinLayerLambdaDeployStack
...
lambda_stack = NyuProteinLayerLambdaDeployStack(app, 'NyuProteinLayerLambdaAGWDeployStack',vpc_stack.vpc, neptune_stack.graph_db_ep,rds_stack.rds_ep, env = env)
